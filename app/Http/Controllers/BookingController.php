...
class BookingController extends Controller
{
    ...
    {
        // add a default value to $response if both if fails
        $response = [];
        // take user id as variable above
    ...
    public function update($id, Request $request)
    {
        ...
        // array_except is deprecated - use new one
    ...
    public function distanceFeed(Request $request)
    {
        ...
        // define variables with predefined value before hand
        $distance = "";
        $time = "";
        $session = "";
        $flagged = 'no';
        ...
        if ($data['flagged'] == 'true') {
            // bad way of using return in between code like that
            if($data['admincomment'] == '') {
                // update a proper response;
